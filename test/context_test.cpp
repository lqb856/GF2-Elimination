...
TEST(TestContext, TestFirstBit) {
  // 斷言示例
  int data_set = 6;
  int thread_num = 192; // for ge_pthread
  int lock_num = 2048;
  ...
  int index_size =
      ctx.er_.bitmap_matrix_.num_cols_ + ctx.es_.bitmap_matrix_.num_cols_ + 1;
  ...
  std::cout << "ge_base time: " << duration.count() << " milliseconds"
            << std::endl;
  ...
  std::cout << "ge_sse128 time: " << duration.count() << "milliseconds"
            << std::endl;
  ...
  duration = std::chrono::duration_cast<std::chrono::milliseconds>(end - start);
  std::cout << "ge_avx256 time: " << duration.count() << "milliseconds"
            << std::endl;
  // save_bitmap_matrix(res_file, ctx.er_.bitmap_matrix_);
  ...
  duration = std::chrono::duration_cast<std::chrono::milliseconds>(end - start);
  std::cout << "ge_avx512 time: " << duration.count() << "milliseconds"
            << std::endl;
  // save_bitmap_matrix(res_file, ctx.er_.bitmap_matrix_);
  ...
  duration = std::chrono::duration_cast<std::chrono::milliseconds>(end - start);
  std::cout << "ge_pthread time: " << duration.count() << "milliseconds"
            << std::endl;
  delete[] ctx5.index_;
  ...
  start = std::chrono::high_resolution_clock::now();
  ge_omp(&ctx6, thread_num, lock_num, false);
  end = std::chrono::high_resolution_clock::now();
  duration = std::chrono::duration_cast<std::chrono::milliseconds>(end - start);
  std::cout << "ge_omp time: " << duration.count() << "milliseconds"
            << std::endl;
  delete[] ctx6.index_;
  ...
  duration = std::chrono::duration_cast<std::chrono::milliseconds>(end - start);
  std::cout << "ge_pthread_avx time: " << duration.count() << " milliseconds"
            << std::endl;
  delete[] ctx7.index_;
  ...
  start = std::chrono::high_resolution_clock::now();
  ge_omp(&ctx8, thread_num, lock_num);
  end = std::chrono::high_resolution_clock::now();
  duration = std::chrono::duration_cast<std::chrono::milliseconds>(end - start);
  std::cout << "ge_omp_avx time: " << duration.count() << " milliseconds"
            << std::endl;
  delete[] ctx8.index_;
}